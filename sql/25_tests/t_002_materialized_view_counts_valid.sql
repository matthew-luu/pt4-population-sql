...
BEGIN
    ...
    IF EXISTS (
        ...
        RAISE EXCEPTION 't_002 failed: mv_player_response_vs_open_counts has call_cnt > def_opp';
    END IF;
    ...
    IF EXISTS (
        ...
        RAISE EXCEPTION 't_002 failed: mv_player_response_vs_open_counts has threebet_cnt > def_opp';
    END IF;
